<template>
  ...
  >
    <div
      class="w-full p-6 m-auto bg-white border-t border-blue-600 rounded shadow-lg shadow-blue-800/50 lg:max-w-md"
    >
      <!-- <h1
        class="text-3xl font-semibold text-center text-white rounded-md bg-blue-600"
      >
        SOLUTECH
      </h1> -->
      <!-- LOGO -->
