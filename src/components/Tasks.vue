<template>
  ...
  >
    <div class="flex flex-col md:flex-row">
      <ul
        class="flex flex-row md:flex-col w-full md:w-1/4 mx-auto py-4 md:py-0 sm:mx-0"
      >
            ...
            <tr class="py-10 font-medium divide-x group hover:bg-gray-50">
              <td class="flex-row px-2 py-4 items-center">
                <div class="flex">
                  ...
                  >
                    Run insurance for the Wren family
                  </div>
                </div>
              </td>
              <td class="items-center px-4 py-4">
                <div class="flex flex-row items-center">
                  ...
                  <div class="flex-1 pl-1">
                    <div
                      class="font-medium dark:text-white dark:group-hover:text-gray-600"
                    >
                      Ashley J. Simmons
                    </div>
                  </div>
              ...
              <td class="items-center px-4 py-4">
                <div
                  class="font-medium text-sm dark:text-gray-50 dark:group-hover:text-gray-600"
                >
                  Complete
                </div>
              </td>
            ...
            <tr class="py-10 font-medium divide-x group hover:bg-gray-50">
              <td class="flex-row px-2 py-4 items-center">
                <div class="flex">
                  ...
                  <div
                    class="flex text-sm dark:text-gray-200 group-hover:text-blue-500 dark:group-hover:text-gray-600"
                  >
                    Prep for clinic morning standup
                  </div>
                </div>
              </td>
              <td class="items-center px-4 py-4">
              ...
              <td class="px-4 py-4 items-center">
                <button
                  class="px-2 py-2 bg-blue-100 dark:bg-gray-300 rounded text-gray-500 dark:group-hover:text-gray-600 text-xs font-medium"
                >
                  12 Jan 2023
                </button>
              </td>
            ...
            <tr class="py-10 font-medium divide-x group hover:bg-gray-50">
              <td class="flex-row px-2 py-4 items-center">
                <div class="flex">
                  ...
                  <div
                    class="flex text-sm dark:text-gray-200 group-hover:text-red-500 dark:group-hover:text-gray-600"
                  >
                    Update insurance for Ezra Bridger
                  </div>
                </div>
              </td>
              <td class="items-center px-4 py-4">
              ...
              <td class="px-4 py-4 items-center">
                <button
                  class="px-2 py-2 bg-yellow-100 dark:bg-gray-300 rounded text-gray-500 dark:group-hover:text-gray-600 text-xs font-medium"
                >
                  12 Jan 2023
                </button>
              </td>
